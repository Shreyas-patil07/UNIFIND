...
class ProductRepositoryInterface(BaseRepository[Dict[str, Any]]):
    ...
    async def get_by_seller(
        self, seller_id: str, limit: Optional[int] = None, offset: Optional[int] = None
    ) -> List[Dict[str, Any]]:
...
class ChatRepositoryInterface(BaseRepository[Dict[str, Any]]):
    ...
    @abstractmethod
    async def get_by_participants(self, user1_id: str, user2_id: str) -> Optional[Dict[str, Any]]:
    ...
    @abstractmethod
    async def add_message(self, chat_id: str, message_data: Dict[str, Any]) -> bool:
        """Add a message to a chat."""
        pass

    @abstractmethod
    async def get_messages(
        self, chat_id: str, limit: int = 100, before_timestamp: Optional[datetime] = None
    ) -> List[Dict[str, Any]]:
...
class ReviewRepositoryInterface(BaseRepository[Dict[str, Any]]):
    ...
    @abstractmethod
    async def get_by_product(self, product_id: str, limit: int = 50) -> List[Dict[str, Any]]:
    ...
    @abstractmethod
    async def get_for_seller(self, seller_id: str, limit: int = 50) -> List[Dict[str, Any]]:
    ...
    @abstractmethod
    async def has_reviewed(self, user_id: str, product_id: str) -> bool:
...
class TransactionRepositoryInterface(BaseRepository[Dict[str, Any]]):
    ...
    @abstractmethod
    async def get_by_buyer(self, buyer_id: str, limit: int = 50) -> List[Dict[str, Any]]:
        """Get all transactions for a buyer."""
        pass

    @abstractmethod
    async def get_by_seller(self, seller_id: str, limit: int = 50) -> List[Dict[str, Any]]:
