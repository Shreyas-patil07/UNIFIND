...
class TestTransactionRoutes:
    ...
    async def test_get_user_transactions(self, client: AsyncClient, sample_user, sample_transaction):
        ...
        with patch('app.api.dependencies.auth.get_current_user') as mock_auth:
            ...
            with patch('app.services.transaction_service.TransactionService.get_user_transactions') as mock_get:
    ...
    async def test_get_transaction_stats(self, client: AsyncClient, sample_user):
        ...
        with patch('app.api.dependencies.auth.get_current_user') as mock_auth:
            ...
            with patch('app.services.transaction_service.TransactionService.get_transaction_stats') as mock_stats:
